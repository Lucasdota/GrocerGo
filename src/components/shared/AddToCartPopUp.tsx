...
const AddToCartPopUp = ({ name, setPopUp }: Props) => {
  return (
    <motion.div
    ...
    >
      ...
      <p className="text-green-5 text-[0.98rem] font-sans">
        <span className="text-green-4">{name}</span>&nbsp;added to cart.
      </p>
      <button onClick={() => setPopUp(false)} className="rounded-full hover:bg-neutral-200/50 p-1">
